      ...
      >
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-3">
            <Image src="/logo.png" alt="Daisy Logo" width={40} height={40} className="object-contain" />
            <span className="logo-text text-4xl text-primary">Daisy</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-8 text-[15px] font-medium text-foreground">
            ...
            <Link href="/shop" className="flex items-center hover:text-primary transition-colors">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <button onClick={toggleCart} className="hover:text-primary transition-colors relative text-foreground">
              ...
              <nav className="flex flex-col px-6 py-4 space-y-4 text-sm font-medium text-foreground">
                ...
                <div className="border-t border-gray-100 pt-4 flex space-x-6">
                  ...
                  <button onClick={toggleCart} className="relative">
                    <ShoppingBag size={20} />
                    {cartCount > 0 && (
                      <span className="absolute -top-1.5 -right-2 bg-sale text-black text-[10px] font-bold w-4 h-4 flex items-center justify-center rounded-full">
                        {cartCount}
                      </span>
                    )}
                  </button>
